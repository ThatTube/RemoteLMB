...
public class Modelmagma_pit<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(-25, 0)
				.addBox(-12.0F, 0.0F, -13.0F, 24.0F, 0.0F, 25.0F, new CubeDeformation(0.0F)),
