...
public class Modelbracadeira<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bracadeira"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorLeftArm = bipedLeftArm.addOrReplaceChild("armorLeftArm",
				CubeListBuilder.create().texOffs(16, 32)
						.addBox(2.0F, -1.5F, -2.5F, 2.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 16)
						.addBox(-1.0F, 2.5F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
