...
public class Modelmetalix_chestplate<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "metalix_chestplate"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorBody = bipedBody.addOrReplaceChild("armorBody",
				CubeListBuilder.create().texOffs(24, 16)
						.addBox(-4.0F, 0.0F, -3.0F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.5F)).texOffs(24, 28)
						.addBox(-4.0F, 6.0F, -2.5F, 8.0F, 6.0F, 5.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition armorRightArm = bipedRightArm.addOrReplaceChild("armorRightArm",
				CubeListBuilder.create().texOffs(52, 12)
						.addBox(-4.5F, -4.5F, -3.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 39)
						.addBox(-3.5F, 2.5F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(48, 51)
						.addBox(-3.5F, -5.5F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition armorLeftArm = bipedLeftArm.addOrReplaceChild("armorLeftArm",
				CubeListBuilder.create().texOffs(48, 0)
						.addBox(-1.5F, 2.5F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(50, 28)
						.addBox(-0.5F, -5.5F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						.addBox(1.5F, -4.5F, -3.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
