...
public class BossDamageHandler {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        // Verifica se é dano de instakill (outOfWorld ou dano extremamente alto)
        if (event.getSource().getMsgId().equals("outOfWorld") || event.getAmount() > 1000.0f) {
            return; // Não aplica o damage cap
        }
