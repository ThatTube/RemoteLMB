...
public class EnergyAltarTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public EnergyAltarTileEntity(BlockPos pos, BlockState state) {
		super(MorebossesModBlockEntities.ENERGY_ALTAR.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(EnergyAltarBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<EnergyAltarTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<EnergyAltarTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("energy_altar");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Energy Altar");
	}
