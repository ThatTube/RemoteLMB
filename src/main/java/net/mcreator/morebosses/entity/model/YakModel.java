...
public class YakModel extends GeoModel<YakEntity> {
	...
	public ResourceLocation getAnimationResource(YakEntity entity) {
		return new ResourceLocation("morebosses", "animations/yak.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(YakEntity entity) {
		return new ResourceLocation("morebosses", "geo/yak.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(YakEntity animatable, long instanceId, AnimationState animationState) {
