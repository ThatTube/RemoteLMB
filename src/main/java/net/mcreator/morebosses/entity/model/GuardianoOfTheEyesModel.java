...
public class GuardianoOfTheEyesModel extends GeoModel<GuardianoOfTheEyesEntity> {
	...
	@Override
	public ResourceLocation getTextureResource(GuardianoOfTheEyesEntity entity) {
		return new ResourceLocation("morebosses", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(GuardianoOfTheEyesEntity animatable, long instanceId, AnimationState animationState) {
