...
import net.mcreator.morebosses.procedures.TurretOnInitialEntitySpawnProcedure;
...
public class TurretEntity extends TamableAnimal implements RangedAttackMob, GeoEntity {
	...
	public TurretEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MorebossesModEntities.TURRET.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new TurretEntity.RangedAttackGoal(this, 1.25, 20, 10f) {
			@Override
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		TurretOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		TurretEntityProjectile entityarrow = new TurretEntityProjectile(MorebossesModEntities.TURRET_PROJECTILE.get(), this, this.level());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TurretEntity retval = MorebossesModEntities.TURRET.get().create(serverWorld);
