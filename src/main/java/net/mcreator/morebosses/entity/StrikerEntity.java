...
public class StrikerEntity extends Monster implements GeoEntity {
	...
	public StrikerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MorebossesModEntities.STRIKER.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MorebossesModItems.STRIKER_EYE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(MorebossesModEntities.STRIKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			if (this.isAggressive() && event.isMoving()) {
				return event.setAndContinue(RawAnimation.begin().thenLoop("agro"));
			}
