...
import net.mcreator.morebosses.procedures.TallEngineerOnEntityTickUpdateProcedure;
...
public class TallEngineerEntity extends Monster implements GeoEntity {
	...
	public void baseTick() {
		super.baseTick();
		TallEngineerOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
