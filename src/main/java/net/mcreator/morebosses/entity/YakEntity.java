...
public class YakEntity extends TamableAnimal implements GeoEntity {
	...
	public YakEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MorebossesModEntities.YAK.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		YakEntity retval = MorebossesModEntities.YAK.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Blocks.MOSS_BLOCK.asItem(), Items.SWEET_BERRIES, Blocks.GRASS.asItem()).contains(stack.getItem());
	}
	...
	public static void init() {
		SpawnPlacements.register(MorebossesModEntities.YAK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
