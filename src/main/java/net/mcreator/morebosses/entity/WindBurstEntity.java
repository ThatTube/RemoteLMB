...
public class WindBurstEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.STRUCTURE_BLOCK);

	public WindBurstEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MorebossesModEntities.WIND_BURST.get(), world);
	}

	public WindBurstEntity(EntityType<? extends WindBurstEntity> type, Level world) {
		super(type, world);
	}

	public WindBurstEntity(EntityType<? extends WindBurstEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public WindBurstEntity(EntityType<? extends WindBurstEntity> type, LivingEntity entity, Level world) {
	...
	public static WindBurstEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		WindBurstEntity entityarrow = new WindBurstEntity(MorebossesModEntities.WIND_BURST.get(), entity, world);
	...
	public static WindBurstEntity shoot(LivingEntity entity, LivingEntity target) {
		WindBurstEntity entityarrow = new WindBurstEntity(MorebossesModEntities.WIND_BURST.get(), entity, entity.level());
