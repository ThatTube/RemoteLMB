...
public class ModelCustomArmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("morebosses", "model_custom_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armorLeftBoot = bipedLeftLeg.addOrReplaceChild("armorLeftBoot",
				CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, 6.75F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(48, 8).addBox(-3.0F, 4.75F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(-0.25F)).texOffs(48, 33)
						.addBox(-2.0F, 7.75F, -6.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.3F)).texOffs(24, 25).addBox(-2.0F, 10.55F, -6.0F, 4.0F, 1.0F, 8.0F, new CubeDeformation(0.5F)),
		...
		PartDefinition armorRightBoot = bipedRightLeg.addOrReplaceChild("armorRightBoot",
				CubeListBuilder.create().texOffs(48, 0).addBox(-3.0F, 4.75F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(-0.25F)).texOffs(48, 16).addBox(-2.0F, 6.75F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(48, 25)
						.addBox(-2.0F, 7.75F, -6.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.3F)).texOffs(24, 16).addBox(-2.0F, 10.55F, -6.0F, 4.0F, 1.0F, 8.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
