...
import net.mcreator.morebosses.item.TwoHeadedMaceItem;
...
import net.mcreator.morebosses.item.OldSteelCurvesickleItem;
...
import net.mcreator.morebosses.item.IronDaggerItem;
import net.mcreator.morebosses.item.HuntersClawItem;
...
import net.mcreator.morebosses.item.EnergyShardItem;
import net.mcreator.morebosses.item.EnergyDaggerItem;
import net.mcreator.morebosses.item.EnderEyeItem;
import net.mcreator.morebosses.item.EnderDiscItem;
...
public class MorebossesModItems {
	...
	public static final RegistryObject<Item> PETALED_SANSTONE = block(MorebossesModBlocks.PETALED_SANSTONE);
	public static final RegistryObject<Item> EIGHT_PETALED_GENERAL_SPAWN_EGG = REGISTRY.register("eight_petaled_general_spawn_egg", () -> new ForgeSpawnEggItem(MorebossesModEntities.EIGHT_PETALED_GENERAL, -1, -1, new Item.Properties()));
	public static final RegistryObject<Item> STATUE_STAND = block(MorebossesModBlocks.STATUE_STAND);
	public static final RegistryObject<Item> ENERGY_SHARD = REGISTRY.register("energy_shard", () -> new EnergyShardItem());
	public static final RegistryObject<Item> ENERGY_DAGGER = REGISTRY.register("energy_dagger", () -> new EnergyDaggerItem());
	public static final RegistryObject<Item> IRON_DAGGER = REGISTRY.register("iron_dagger", () -> new IronDaggerItem());
	public static final RegistryObject<Item> OLD_STEEL_CURVESICKLE = REGISTRY.register("old_steel_curvesickle", () -> new OldSteelCurvesickleItem());
	public static final RegistryObject<Item> HUNTERS_CLAW = REGISTRY.register("hunters_claw", () -> new HuntersClawItem());
	public static final RegistryObject<Item> TWO_HEADED_MACE = REGISTRY.register("two_headed_mace", () -> new TwoHeadedMaceItem());
	public static final RegistryObject<Item> ENDER_DISC = REGISTRY.register("ender_disc", () -> new EnderDiscItem());
