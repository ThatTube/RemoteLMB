...
import net.mcreator.morebosses.procedures.COnKeyPressedProcedure;
...
public class CMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			COnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		MorebossesMod.addNetworkMessage(CMessage.class, CMessage::buffer, CMessage::new, CMessage::handler);
	}
}
