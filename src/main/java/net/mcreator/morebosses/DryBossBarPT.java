...
public class DryBossBarPT {
	private static final ResourceLocation CUSTOM_BAR_BG = new ResourceLocation("morebosses", "textures/screens/dryempty.png");
	private static final ResourceLocation CUSTOM_BAR_FILL = new ResourceLocation("morebosses", "textures/screens/dryefull.png");

	@SubscribeEvent
	public static void onRenderBossBar(CustomizeGuiOverlayEvent.BossEventProgress event) {
		// Filtro inicial pelo nome padrão
		if (event.getBossEvent().getName().getString().contains("Dry Bones, o da Couraça de Pedra")) {
			...
			guiGraphics.drawString(mc.font, nameToShow, textX, textY, 0x181d1d, false);
		}
	}
}
