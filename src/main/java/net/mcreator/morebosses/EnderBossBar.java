...
public class EnderBossBar {
	private static final ResourceLocation CUSTOM_BAR_BG = new ResourceLocation("morebosses", "textures/screens/guardianeyesbarrfull.png");
	private static final ResourceLocation CUSTOM_BAR_FILL = new ResourceLocation("morebosses", "textures/screens/guardianeyesbarrempty.png");

	@SubscribeEvent
	public static void onRenderBossBar(CustomizeGuiOverlayEvent.BossEventProgress event) {
		// Filtro inicial pelo nome padrão
		if (event.getBossEvent().getName().getString().contains("Ender, the Eye of the Chaos")) {
			...
			guiGraphics.drawString(mc.font, nameToShow, textX, textY, 0x82ff00, true);
		}
	}
}
