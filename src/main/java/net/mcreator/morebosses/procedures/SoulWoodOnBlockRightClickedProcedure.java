...
public class SoulWoodOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (Items.SHEARS == (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()) {
			if (!(new Object() {
			...
			}
			{
				...
				BlockState _bs = MorebossesModBlocks.SOUL_WOOD_FACE.get().defaultBlockState();
