...
public class GongOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == MorebossesModItems.GONG_STICK.get()) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = MorebossesModEntities.DRY_BONES.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
