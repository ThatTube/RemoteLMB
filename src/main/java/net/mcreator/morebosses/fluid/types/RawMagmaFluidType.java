...
public class RawMagmaFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("morebosses:block/raw_magma");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("morebosses:block/raw_magma");
