...
public class CuirlassSmithingUpgradeItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.morebosses.cuirlass_smithing_upgrade.description_0"));
		list.add(Component.translatable("item.morebosses.cuirlass_smithing_upgrade.description_1"));
