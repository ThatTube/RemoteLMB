...
public class MaxoBossBarPT {
	private static final ResourceLocation CUSTOM_BAR_BG = new ResourceLocation("morebosses", "textures/screens/maxo_bar_suor.png");
	private static final ResourceLocation CUSTOM_BAR_FILL = new ResourceLocation("morebosses", "textures/screens/maxo_bar_color.png");

	@SubscribeEvent
	public static void onRenderBossBar(CustomizeGuiOverlayEvent.BossEventProgress event) {
		// Filtro inicial pelo nome padrão
		if (event.getBossEvent().getName().getString().contains("Macholote, o Terror dos 7 tanquinhos")) {
			...
			guiGraphics.drawString(mc.font, nameToShow, textX, textY, 0xFF69B4, true);
		}
	}
}
